...
console.log(linearSearch3([-5,2,10,4,6], 10)) // 2
console.log(linearSearch3([-5,2,10,4,6], 6)) // 4
console.log(linearSearch3([-5,2,10,4,6], 20)) // -1
...
console.log(linearSearch2(10)) // 2
console.log(linearSearch2(6)) // 4
console.log(linearSearch2(20)) // -1